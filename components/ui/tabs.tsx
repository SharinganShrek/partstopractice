...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex w-full overflow-x-auto h-10 items-center justify-start rounded-lg bg-surface-cream p-1 text-text-muted -mx-1 px-1',
      className
    )}
    {...props}
  />
