      ...
      <div className="bg-[#800020] text-white py-6">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-[#f5f5dc]/80 text-sm mt-1">Video talepleri ve LMS yönetimi</p>
          </div>
          <button
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <Tabs defaultValue="videos">
          <TabsList className="mb-6">
            <TabsTrigger value="videos">Video Talepleri</TabsTrigger>
            <TabsTrigger value="lms">Yaz Kursu LMS</TabsTrigger>
          </TabsList>
