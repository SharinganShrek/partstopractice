    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
        <div className="relative w-full max-w-6xl bg-white rounded-lg shadow-2xl pointer-events-auto flex flex-col max-h-[90vh]">
          <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-200 flex-shrink-0 min-w-0">
            <h2 className="text-lg font-semibold text-[#212529] truncate min-w-0 flex-1 pr-4">{course.title}</h2>
            <button
              onClick={onClose}
